                        ...
                        <div class="row" style="width:40%">
                            <div class="col s12">
                                <div class="row">
                                    ...
                                    echo("<div>");
                                    require_once 'database.php';
                                    $requete_langue = "select langue from langues";
                                    $resultat_langue = mysqli_query($database, $requete_langue)or die(mysql_error());
                                    $langue = array();
                                    $i = 0;
                                    while ($ligne_langue = mysqli_fetch_array($resultat_langue, MYSQLI_NUM)) {
                                    ...
                                    echo"<label for='id_nounou'> Langues parlées </label>";
                                    echo ("<select multiple name ='id_nounou[]'>");
                                    $j = 1;
...
function langues($database) {
    require_once 'database.php';
    $requete = "select langue from langues";
